"""Versioned Instron analysis, with explicit output and optional frozen settings."""
...
if __name__=='__main__':
    ...
    p.add_argument('--force-column');p.add_argument('--displacement-column');p.add_argument('--time-column')
    p.add_argument('--needles',type=int);p.add_argument('--proposal-metadata',type=Path)
    a=p.parse_args()
    ...
    result=export_analysis(_read_bluehill_csv(a.source),a.force_column,a.displacement_column,cfg,a.needles,a.source,a.output_dir,a.time_column)
